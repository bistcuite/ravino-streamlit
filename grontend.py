...
یادآوری مهم: همیشه روایت را به زبان فارسی و از دوم شخص (تو) ادامه بده. هرگز مستقیماً از کاربر نپرس که چه می‌خواهد بکند، بلکه داستان را روایت کن و منتظر تصمیم او بمان.""",
)
